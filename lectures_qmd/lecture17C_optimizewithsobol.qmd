...
-   [Communications of the ACM]("papers/AIinComputingEducation.pdf")

-   [Practical overview/perspective]("papers/perspectives_ai_coding.pdf")

-   [Recent review on potential harmful consequenses]("papers/review-of-harms-fromAIcodingedu.pdf")
...
## Optimization in R - an example {.scrollable}
...
## Sensitivity analysis AND optimization? {.scrollable}
...
## Sobol with some help with copilot {.scrollable}
