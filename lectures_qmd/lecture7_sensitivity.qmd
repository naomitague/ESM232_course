...
where \( k \ge 1 \) controls how sharply runoff increases beyond the threshold.
...
simple_erosion(I = 2, f = 4, k = 2, a = 3)
...
estimate = map(f, ~ erosion(I = 2, f = .x)) %>%
  unlist()
...
pnorm(1.9, mean = 5, sd = 2)
simple_erosion(I = 2, f = 1.9)

pnorm(0.5, mean = 5, sd = 2) rm
simple_erosion(I = 2, f = 0.5)

```


## More Formal Approaches to efficiently sampling parameter space
