...
similar goal to Sobol sampling - efficiently sample parameter space - but we are
**searching** with an objective rather than sampling to get a **picture** of the whole space
...
Sampling parameters to avoid local minimum and maximum
![](img/optsurface2.png)
...
Pollution as a function of temperature
