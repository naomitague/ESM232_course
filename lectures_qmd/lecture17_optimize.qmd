...
result <- water_price %>% map_df(~ optimize(compute_profit, lower = 0, upper = 1000, T =temp, P = precip, discount = discount, price = crop_price, cost = .x, crop.pars = crop_pars, maximum = TRUE))
...
ggplot(result, aes(water_price, maximum)) +
  geom_point(col = "green", size = 2)+labs(y = "Optimal Irrigation (mm)", x = "Water Price ($/mm)") 
...
and reminder to do course evaluations
