...
-   Basics of building your own model - modularity, functions, inputs/outputs/parameters - and why you might want to do that
...
save(sierraczosolar, file="Data/sierraczosolar_clean.rda")
