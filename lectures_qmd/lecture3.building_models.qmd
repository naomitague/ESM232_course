...
Lets consider two example questions involving tree water use (evapotranspiration) (physically based rather than statistical model)
...
\*\* is model structure appropriate (fits your conceptual model) \*\* is performance good enough (performance) to answer your question
