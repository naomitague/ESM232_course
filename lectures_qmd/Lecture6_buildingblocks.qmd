---
title: "Lecture5_notused_buildingblocks"
format:
  revealjs:
    theme: solarized
    resources: ["img/"]
...
What if price increased by a % each year?
How would you modify **compute_profit_frompower** to account for that?
Or alternatively - what if you wanted to input a different price for each year?
