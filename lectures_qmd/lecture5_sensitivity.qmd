...
<span style="color: blue;"> A 1% change in **K** will lead to a 1% change in Power
...
<span style="color: blue;"> So you could say that Power is more sensitive to efficiency for larger flow rates or larger heights, We know this because the are multiplied together!
...
<span style="color: blue;"> Which coefficient will matter more?

<span style="color: blue;"> *IF* **P** and **T** where in the same units (e.g percent deviation from a mean value), then you could use the coefficients to tell you if parrot suitablity would be more sensitive to a 10% change in preciitation versus a 10% change in temperature
...
generating random samples from equally probability intervals ![](lecture7_sensitivity/assets/img/image3.png)
...
Nice paper on sensitivity analysis for environmental modeling <a href="../img/Saltelli.2010.pdf" download>Click to Download</a>
