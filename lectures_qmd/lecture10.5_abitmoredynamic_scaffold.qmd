...
# single column (time)
plot(resfast_fixtime$conc[,3], ylab="Concentration for location 3", xlab="Time")
...
spatial_metrics = cbind.data.frame(cvar, cmean, time=seq(from=1, to=100))
# notice its the same as the number of time units (nt) used above

# plot spatial variation through time
ggplot(spatial_metrics, aes(time, cvar))+geom_line() + labs(y="Spatial Variation")
