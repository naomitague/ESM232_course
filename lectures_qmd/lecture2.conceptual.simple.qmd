...
Whats in your conceptual model - pick one and summarize in Quiz Inverse Inference on Canvas
...
e.g 
$Pop_newt = \beta_1 * \beta_2* precipitation + \beta_2*temperature +  \beta_2*presenceof predators + \beta_2*roaddensity + \beta_2*pollutionlevels$
...
# Develop a Conceptual Model - Discussion Section   
...
You will expand on this in next weeks discussion section
