...
* For a challenge - think about how you might change your  model so that it would work for all tree yields considered by the Lobell paper
...
Conceptual model (30 pts)
  ...
  * correct inputs and output and parameters shown on the diagram (10 pts)
  * clear diagram (10 pts)
