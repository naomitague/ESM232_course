...
2) in an Rmarkdown document, write code to read in the “clim.txt”, (attached here) do any subsetting required for input to your function, run the function and save results
