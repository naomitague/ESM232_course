...
lotvmodKvar <- function(t, pop, pars) {
  with(as.list(c(pars, pop)), {
    # compute current carrying capacity based on temperature
    K = KO * (1 - Ksen * (airT[t] - Topt))
    K = max(K, 1) # carrying capacity can't be 0 or negaitve minimum is 1
