...
-   here's the site: "<https://github.com/naomitague/EDS-230-ESM-232-W26.git>"

-   Remember that in *git* does not allow nested repositories - so *clone* the class site somewhere that it will not overlap with other repositories. I recommend that you *fork* the repository so you can modify it and add to it; but keep an upstream remote so you can regularly sync with the class repository.
...
"Disturbance with Dynamic Models",
"Using Copilot tools ",
"2 Variable and Stability",
"What makes a good model",
"Guest Lecture (Cap) (no discussion)",
"Calibration",
"Calibration2",
...
| Feb 10 / 17      | Dynamic Model and Sensitivity     | 15          |
| Feb 10 / March 9 | Final Assignment: Model Plan      | 15          |
