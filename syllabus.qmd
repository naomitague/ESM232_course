...
-   All of the class material (example functions, data, and Quato presentations from lectures) will be available on the course *github* site. I will update the repository before each class- so make sure you pull before class so you have access to all of the materials.
...
There are pro's and con's to using AI-tools while you are learning
environmental modeling (coding in general)
